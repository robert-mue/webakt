...
<div class="content" style="background:inherit; border:none;padding:15px;">
    ...
    <div>
        ...
        <button class="button_accept" local_id="button_accept" style="float:left; margin-left:15px; background;white; font-weight:bold; font-size:24px; color:#00cc00;">&#10004;</button>
        <div style="clear:both;"></div>
    </div>
    ...
    <div class="w3-row">
        <div class="w3-col w3-right w3-container" style="width:80px">
            ...
            <button class="button_update" local_id="button_update" style="width:70px; margin:3px;">Update</button>
        </div>
